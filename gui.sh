...
echo After this step, follow the \"Chrooted system\" \(GUI mode\) step in the README.md guide
echo Also, provide this key as parameter the gui_chroot.sh: \"${key}\" \(without quotes)
arch-chroot /mnt
